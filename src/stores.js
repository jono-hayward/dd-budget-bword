...
const stored_prefs = store_get( 'localStorage', 'prefs' );
export const prefs = writable( stored_prefs && JSON.parse( stored_prefs ) || {} );
prefs.subscribe( value => store_set( 'localStorage', 'prefs', JSON.stringify(value) ) );
